    ...
    return (
        <>
            <button
                ...
                className="bg-gray-50 border border-gray-200 hover:bg-gray-100 hover:border-gray-300 text-gray-700 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 shadow-sm transition-all"
            >
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-300">
                    ...
                    <div className="bg-white rounded-[2rem] w-full max-w-md relative z-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden animate-in zoom-in-95 duration-300">
                        <div className="bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 p-6 flex justify-between items-start">
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h3 className="text-lg font-black text-black tracking-tight line-clamp-1">{menuName}</h3>
                                    <p className="text-3xs text-gray-500 mt-0.5 font-medium uppercase tracking-wider">Attach Addons to Main Menu</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest">Select Addon Categories</label>
                                
                                {allAddonCategories.length === 0 ? (
                                    <div className="text-center py-6 bg-gray-50 border border-dashed border-gray-200 rounded-xl">
                                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">No Addon Categories Found</p>
                                        <p className="text-[10px] text-gray-400 mt-1">Please create them in the Addons tab first.</p>
                                    </div>
                                ) : (
                                            ...
                                            return (
                                                ...
                                                >
                                                    <input 
                                                        ...
                                                        disabled={isPending}
                                                        className="w-4 h-4 text-black border-gray-300 rounded focus:ring-black accent-black shrink-0" 
                                                    />
                                ...
                                <div className="flex justify-end gap-2 pt-6 border-t border-gray-100 mt-6">
                                    <button 
                                        ...
                                        disabled={isPending}
                                        className="bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-black px-5 py-2.5 rounded-xl text-[10px] font-black transition-colors uppercase tracking-widest"
                                    >
                                        Cancel
                                    </button>
                                    <button 
