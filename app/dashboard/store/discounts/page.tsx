        ...
        <div className="space-y-6 lg:space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 md:p-8 bg-white/60 backdrop-blur-xl rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h1 className="text-2xl md:text-3xl font-black uppercase tracking-tight text-black">Promotions</h1>
                        <p className="text-[10px] md:text-xs font-bold text-gray-400 mt-1 uppercase tracking-widest">လျှော့စျေးများကို သတ်မှတ်ပါ</p>
                    </div>
                </div>
                <div className="px-5 py-3.5 bg-white rounded-2xl border border-gray-100 flex items-center gap-4 shadow-sm shrink-0">
                    ...
                    <div>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Active Promos</p>
                        <p className="text-xl font-black text-black leading-none mt-1">{discounts.filter(d => d.isActive).length}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-4 bg-white/60 backdrop-blur-xl rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 lg:p-8 h-fit lg:sticky top-6 relative overflow-hidden group">
                    <div className="flex items-center gap-3 mb-6 md:mb-8 pb-4 border-b border-gray-200/50">
                        ...
                        <h2 className="text-sm font-black uppercase tracking-wider text-black">New Promotion <span className="font-bold text-gray-400 tracking-normal ml-1 text-[10px]">(အသစ်တည်ဆောက်ရန်)</span></h2>
                    </div>
                    ...
                    >
                        <div className="space-y-1.5">
                            <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest">Campaign Name <span className="text-black">*</span></label>
                            <input
                                type="text"
                                name="name"
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest">Discount Type <span className="text-black">*</span></label>
                            <div className="relative">
                                <select
                                    name="type"
                                    className="w-full bg-white border border-gray-200 rounded-xl p-3 text-xs font-bold text-black focus:outline-none focus:border-black transition-all shadow-sm focus:shadow-md appearance-none"
                                    required
                                >
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full bg-white border border-gray-200 rounded-xl p-3 text-xs font-bold text-black placeholder-slate-400 focus:outline-none focus:border-black transition-all shadow-sm focus:shadow-md font-mono"
                                required
                            />
                        </div>
                ...
                <div className="lg:col-span-8">
                    {discounts.length === 0 ? (
                        <div className="bg-white/60 backdrop-blur-xl rounded-[2rem] border border-gray-100 p-16 text-center flex flex-col items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-full">
                            ...
                            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-1">No Promotions</h3>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">ဘယ်ဘက်ဖောင်မှ စတင်ထည့်သွင်းပါ</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                            {discounts.map((disc) => (
                                <div key={disc.id} className={`group bg-white border ${disc.isActive ? 'border-gray-200' : 'border-gray-100 opacity-60 hover:opacity-100'} rounded-2xl p-6 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 flex flex-col justify-between relative overflow-hidden`}>
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex justify-between items-start gap-2 mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${disc.isActive ? 'bg-black text-white shadow-md shadow-black/10' : 'bg-gray-100 text-gray-400'}`}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                                                </div>
                                                <h4 className={`font-black text-sm uppercase tracking-wider leading-tight transition-colors ${disc.isActive ? 'text-black' : 'text-gray-500'}`}>
                                                    {disc.name}
                                                </h4>
                                            </div>
                                            
                                            <span className={`text-[9px] px-2.5 py-1 rounded-md font-black uppercase tracking-widest shrink-0 ${disc.isActive ? 'bg-green-50 text-green-600 border border-green-200' : 'bg-gray-50 text-gray-400 border border-gray-200'}`}>
                                        ...
                                        <div className="flex items-baseline gap-1 mt-3">
                                            <span className={`text-3xl font-black ${disc.isActive ? 'text-black' : 'text-gray-500'} tracking-tighter`}>
