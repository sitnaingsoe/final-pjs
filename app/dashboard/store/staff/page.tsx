            ...
            <div className="flex justify-between items-end">
                <div>
                    <h2 className="text-3xl font-black text-white flex items-center gap-3">
                        <span className="text-orange-500">👥</span> ဝန်ထမ်းများ (Staffs)
                    </h2>
                    <p className="text-slate-400 mt-2">သင့်ဆိုင်ခွဲအတွက် အရောင်းဝန်ထမ်းများကို စီမံခန့်ခွဲပါ</p>
                </div>
                <CreateStaffForm />
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                {staffs.length === 0 ? (
                    <div className="p-12 text-center flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-300">ဝန်ထမ်းစာရင်း မရှိသေးပါ</h3>
                        <p className="text-slate-500 mt-2">အပေါ်မှ 'ဝန်ထမ်းအသစ် ထည့်မည်' ကို နှိပ်၍ စတင်ပါ</p>
                    </div>
                ) : (
                                    ...
                                    <tr key={staff.id} className="hover:bg-slate-800/20 transition-colors">
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-rose-500 flex items-center justify-center text-white font-black uppercase shadow-lg shadow-orange-500/20 shrink-0">
